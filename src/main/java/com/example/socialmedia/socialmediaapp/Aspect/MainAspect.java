...
public class MainAspect {
    ...
    @AfterReturning(pointcut = "@annotation(com.example.socialmedia.socialmediaapp.Aspect.SendPasswordResetEmail) && args(payload,request,..)", returning = "responseEntity")
    public void changePassword(JoinPoint joinPoint, @RequestBody Map<String, String> payload,
            HttpServletRequest request, ResponseEntity<?> responseEntity) {
